...
void loop() {
  ...
  if (dustDensityug <= 50.0)                                // 대기 중 미세먼지가 좋음 일때
    light(255, 255, 255);
  else if (50.0 < dustDensityug && dustDensityug <= 70.0)   // 대기 중 미세먼지가 보통 일때
    light(60, 120, 150);
  else if (70.0 < dustDensityug && dustDensityug <= 150.0)  // 대기 중 미세먼지가 나쁨 일때
    light(60, 180, 200);
  else                                                      // 대기 중 미세먼지가 매우 나쁨 일때
    light(20, 180, 255);
